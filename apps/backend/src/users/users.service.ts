...
import { authenticationUserSelect, publicUserSelect } from './user.select';
...
export class UsersService {
  ...
  async findByEmailForPrincipal(principal: AuthPrincipal, email: string) {
  ...
  async addPlayerCoachNote(playerId: string, data: { note: string }) {
  ...
  async updatePlayerHealthStatus(
    ...
    if (data.primaryStatus !== undefined)
      updateData.primaryStatus = data.primaryStatus;
    if (data.injuryType !== undefined) updateData.injuryType = data.injuryType;
    if (data.muscleInjurySubtype !== undefined)
      updateData.muscleInjurySubtype = data.muscleInjurySubtype;
    if (data.ligamentInjurySubtype !== undefined)
      updateData.ligamentInjurySubtype = data.ligamentInjurySubtype;
    if (data.tendonInjurySubtype !== undefined)
      updateData.tendonInjurySubtype = data.tendonInjurySubtype;
    if (data.boneInjurySubtype !== undefined)
      updateData.boneInjurySubtype = data.boneInjurySubtype;
    ...
    if (data.trainingParticipation !== undefined)
      updateData.trainingParticipation = data.trainingParticipation;
    if (data.estimatedReturnDays !== undefined)
      updateData.estimatedReturnDays = data.estimatedReturnDays;
